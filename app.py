...
with st.sidebar:
    ...
    **RANTAI Sentinel** adalah automated ESG compliance manager yang mengintegrasikan data blockchain, data operasional perusahaan, serta standar global ESG untuk membantu organisasi memantau dan memenuhi regulasi keberlanjutan secara otomatis.
    ...
    Menjadi sistem pengawasan ESG yang proaktif, transparan, dan akuntabel, sehingga perusahaan dapat menjaga kepatuhan, meningkatkan performa keberlanjutan, serta membangun kepercayaan pemangku kepentingan.
    ...
    - ⭐ **Star / Fork**: [GitHub repo](https://github.com/mrbrightsides/rantai-sentinel)
